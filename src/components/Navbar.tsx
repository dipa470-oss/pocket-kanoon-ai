      ...
      <div className="max-w-7xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className="flex items-center gap-2.5 group">
          ...
          <div className="flex flex-col leading-tight">
            ...
            <span className="text-[10px] uppercase tracking-[0.2em] text-primary/80 -mt-0.5">AI · India</span>
          </div>
        </Link>
        ...
        <nav className="hidden md:flex items-center gap-8 text-sm text-muted-foreground">
          ...
          <a href="#lawyers" className="hover:text-foreground transition-colors">Lawyers</a>
        </nav>
        ...
        <div className="flex items-center gap-3">
          ...
          <button className="text-sm font-medium px-4 py-2 rounded-md bg-gradient-to-br from-gold-soft to-gold text-primary-foreground shadow-gold hover:opacity-90 transition-opacity">
            Get Started
          </button>
        </div>
      </div>
